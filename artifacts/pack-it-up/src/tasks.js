...
export const INITIAL_TASKS = [
  ...
  base({ id: "f_buyer_dining", title: "Find buyer: dining table/chairs", category: "move", effort: 1, due: "Jul 12", dueDate: "2026-07-12", dueEnd: "2026-07-14", availableFrom: "2026-07-11", targetDate: "2026-07-12", latestDate: "2026-07-14", criticality: 2, binding: { feature: "apartment_item", target: "dining:dining_table", trigger: "buyerFound", resultStatus: "done" } }),
  base({ id: "f_remove_dining", title: "Remove dining set", category: "move", effort: 2, urgency: 2, due: "Jul 16", dueDate: "2026-07-16", dueEnd: "2026-07-18", availableFrom: null, targetDate: "2026-07-16", latestDate: "2026-07-18", criticality: 3, dependencies: ["f_buyer_dining"], dependsNote: "after buyer found", binding: { feature: "apartment_item", target: "dining:dining_table", trigger: "handled", resultStatus: "done" } }),
  ...
  base({ id: "f_remove_coffee", title: "Remove coffee table", category: "move", effort: 2, urgency: 2, due: "Jul 20", dueDate: "2026-07-20", dueEnd: "2026-07-23", availableFrom: null, targetDate: "2026-07-20", latestDate: "2026-07-23", criticality: 3, dependencies: ["f_buyer_coffee"], dependsNote: "after buyer found", binding: { feature: "apartment_item", target: "living:coffee_table", trigger: "handled", resultStatus: "done" } }),
  ...
  base({ id: "f_buyer_desk", title: "Find buyer: office desk and chair", category: "move", effort: 1, due: "Jul 20", dueDate: "2026-07-20", dueEnd: "2026-07-23", availableFrom: "2026-07-18", targetDate: "2026-07-20", latestDate: "2026-07-23", criticality: 2, binding: { feature: "apartment_item", target: "office:desk_hutch", trigger: "buyerFound", resultStatus: "done" } }),
  base({ id: "f_remove_desk", title: "Remove desk and chair", category: "move", effort: 2, urgency: 2, due: "Jul 27", dueDate: "2026-07-27", dueEnd: "2026-07-28", availableFrom: null, targetDate: "2026-07-27", latestDate: "2026-07-28", criticality: 3, dependencies: ["f_buyer_desk"], dependsNote: "after buyer found", binding: { feature: "apartment_item", target: "office:desk_hutch", trigger: "handled", resultStatus: "done" } }),
  ...
  base({ id: "f_remove_dresser", title: "Remove dresser", category: "move", effort: 2, urgency: 2, due: "Jul 27", dueDate: "2026-07-27", dueEnd: "2026-07-29", availableFrom: null, targetDate: "2026-07-27", latestDate: "2026-07-29", criticality: 3, dependencies: ["f_buyer_dresser"], dependsNote: "after buyer found", binding: { feature: "apartment_item", target: "bedroom:dresser", trigger: "handled", resultStatus: "done" } }),
