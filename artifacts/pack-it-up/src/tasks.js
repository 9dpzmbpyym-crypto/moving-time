...
export const INITIAL_TASKS = [
  ...
  base({ id: "p_guitar_amp", title: "Secure guitar/amp/accessories", category: "move", effort: 2, urgency: 2, due: "Jul 25", dueDate: "2026-07-25", dueEnd: "2026-07-26", availableFrom: "2026-07-23", targetDate: "2026-07-25", latestDate: "2026-07-26", criticality: 3, binding: packedCollections("collection:task:guitar gear") }),
  ...
  base({ id: "f_remove_bedframe", dependencies: ["f_bed_plan"], title: "Remove bed frame", category: "move", effort: 2, urgency: 2, due: "Jul 29", dueDate: "2026-07-29", dueEnd: "2026-07-30", availableFrom: "2026-07-28", targetDate: "2026-07-29", latestDate: "2026-07-30", criticality: 3 }),
  ...
  base({ id: "c_med_reaction", dependencies: ["c_med_test"], title: "Record reaction/contact vet if needed", category: "cat", effort: 1, urgency: 2, due: "Jul 28", dueDate: "2026-07-28", dueEnd: "2026-07-30", availableFrom: null, targetDate: "2026-07-28", latestDate: "2026-07-30", criticality: 3, dependsNote: "after medication test run" }),
