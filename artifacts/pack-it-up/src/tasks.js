...
export const INITIAL_TASKS = [
  ...
  base({ id: "f_remove_dining", title: "Remove dining set", category: "move", effort: 2, urgency: 2, due: "Jul 16", dueDate: "2026-07-16", dueEnd: "2026-07-18", availableFrom: null, targetDate: "2026-07-16", latestDate: "2026-07-18", criticality: 3, dependencies: ["f_buyer_dining"], dependsNote: "after buyer found" }),
  ...
  base({ id: "f_remove_entertainment", title: "Remove entertainment center", category: "move", effort: 2, urgency: 2, due: "Jul 19", dueDate: "2026-07-19", dueEnd: "2026-07-22", availableFrom: null, targetDate: "2026-07-19", latestDate: "2026-07-22", criticality: 3, dependencies: ["f_buyer_entertainment"], dependsNote: "after buyer found" }),
  ...
  base({ id: "f_remove_coffee", title: "Remove coffee table", category: "move", effort: 2, urgency: 2, due: "Jul 20", dueDate: "2026-07-20", dueEnd: "2026-07-23", availableFrom: null, targetDate: "2026-07-20", latestDate: "2026-07-23", criticality: 3, dependencies: ["f_buyer_coffee"], dependsNote: "after buyer found" }),
  ...
  base({ id: "f_remove_tv", title: "Remove TV", category: "move", effort: 2, urgency: 2, due: "Jul 28", dueDate: "2026-07-28", dueEnd: "2026-07-29", availableFrom: null, targetDate: "2026-07-28", latestDate: "2026-07-29", criticality: 3, dependencies: ["f_buyer_tv"], dependsNote: "after buyer found" }),
  ...
  base({ id: "f_remove_desk", title: "Remove desk and chair", category: "move", effort: 2, urgency: 2, due: "Jul 27", dueDate: "2026-07-27", dueEnd: "2026-07-28", availableFrom: null, targetDate: "2026-07-27", latestDate: "2026-07-28", criticality: 3, dependencies: ["f_buyer_desk"], dependsNote: "after buyer found" }),
  ...
  base({ id: "f_remove_sofa", title: "Remove sofa", category: "move", effort: 2, urgency: 2, due: "Jul 27", dueDate: "2026-07-27", dueEnd: "2026-07-29", availableFrom: null, targetDate: "2026-07-27", latestDate: "2026-07-29", criticality: 3, dependencies: ["f_buyer_sofa"], dependsNote: "after buyer found" }),
  ...
  base({ id: "f_remove_dresser", title: "Remove dresser", category: "move", effort: 2, urgency: 2, due: "Jul 27", dueDate: "2026-07-27", dueEnd: "2026-07-29", availableFrom: null, targetDate: "2026-07-27", latestDate: "2026-07-29", criticality: 3, dependencies: ["f_buyer_dresser"], dependsNote: "after buyer found" }),
  ...
  base({ id: "f_remove_bedside", title: "Remove bedside table", category: "move", effort: 1, urgency: 2, due: "Jul 28", dueDate: "2026-07-28", dueEnd: "2026-07-29", availableFrom: null, targetDate: "2026-07-28", latestDate: "2026-07-29", criticality: 3, dependencies: ["f_buyer_bedside"], dependsNote: "after buyer found" }),
